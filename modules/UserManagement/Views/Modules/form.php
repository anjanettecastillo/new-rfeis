                                ...
                                <form method="POST" action="/modules/<?= $edit ? 'u/'.esc($id) : 'a'?>">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control <?= isset($errors['description']) ? 'is-invalid':'is-valid' ?>" name="description" placeholder="Description" value="<?= isset($value['module'])? esc($value['module']) : '' ?>">
