...
class OfficersModel extends BaseModel
{
    protected $table = 'frbs_officers';
    ...
    public function getDetails($conditions = []){
            $this->select('frbs_officers.*');// , frbs_organizations.organization_name, frbs_courses.course_name, frbs_year_levels.year, frbs_extension_names.extension_name');
    ...
    public function getStudentData(){
        $this->select('count(id) as officers');
        return $this->findAll();
    }
